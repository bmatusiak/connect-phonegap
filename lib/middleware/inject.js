...
module.exports = function(options) {
    var scriptsToInject = [],
        ...
        scripts.push(path.join(__dirname, '../../res/middleware/autoreload-http.js'));
        //scripts.push(path.join(__dirname, '../../res/middleware/consoler-http.js'));
        scripts.push(path.join(__dirname, '../../res/middleware/homepage.js'));
        scripts.push(path.join(__dirname, '../../res/middleware/proxy.js'));
        scripts.push(path.join(__dirname, '../../res/middleware/refresh.js'));
